          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
              <div className="text-center">
                ...
                <p className="text-muted-foreground text-sm">Live with local families, participate in farm activities, and experience genuine village culture</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground text-sm">Support rural communities while enjoying eco-friendly and culturally immersive experiences</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground text-sm">Every stay directly empowers local families and preserves traditional Tamil Nadu heritage</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-card">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-primary/5 to-accent/20 rounded-2xl p-8">
              <div className="text-center">
                <div className="text-4xl font-bold text-primary mb-2">₹5,502+</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-accent/20 hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold mb-3">Architectural Consultation</h3>
                <p className="text-muted-foreground">
            ...
            <Card className="border-accent/20 hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold mb-3">Farm Activities</h3>
                <p className="text-muted-foreground">
            ...
            <Card className="border-accent/20 hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold mb-3">Slow Living</h3>
                <p className="text-muted-foreground">
